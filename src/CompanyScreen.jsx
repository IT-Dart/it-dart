    ...
    const draw=()=>{
      ...
      for(let i=0;i<particles.length;i++){
        for(let j=i+1;j<particles.length;j++){
          ...
          if(dist<LINK_DIST){
            ctx.strokeStyle=`rgba(56,189,248,${0.1*(1-dist/LINK_DIST)})`;
            ctx.lineWidth=1;
  ...
  return (
    <div style={wrap}><div style={{...inner,paddingTop:40,paddingBottom:40}}>
      <div style={{textAlign:"center",marginBottom:32}}>
        <Logo sz={72}/>
        <div style={{position:"relative",paddingTop:14,paddingBottom:6}}>
          <ParticleBackground/>
          <h1 style={{position:"relative",fontSize:26,fontWeight:700,marginTop:6,marginBottom:6}}>IT-Dart</h1>
          <p style={{position:"relative",fontSize:13,color:C.cy,fontWeight:500,margin:0}}>Digitale Bildung für die IT-Ausbildung</p>
        </div>
      </div>
