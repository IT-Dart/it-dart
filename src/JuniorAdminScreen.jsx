...
export default function JuniorAdminScreen({onClose}){
  ...
  const search=async(e)=>{
    ...
    const {data,error}=await supabase
      .from("profiles")
      .select("id,email,is_premium,premium_until,is_trainer,confirmed_at,created_at,trainee_limit")
  ...
  return(
    <div style={wrap}><div style={inner}>
      ...
      <div style={{background:"#12203f",border:"0.5px solid #1e3a5f",borderRadius:10,padding:"10px 14px",marginBottom:20}}>
        <p style={{fontSize:12,color:"#93c5fd",margin:0,lineHeight:1.6}}>Eingeschränkter Zugang: Nutzer einsehen, einladen und Trainer-Zuordnungen pflegen. Kein Löschen aktiver Konten, keine Vergabe von Admin-/Trainer-/Premium-Rechten.</p>
      </div>
