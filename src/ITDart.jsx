  ...
  if(mid==="g")return(
    <SVG>
      ...
      {n===4&&<>
        ...
        <rect x="105" y="50" width="155" height="140" rx="8" fill="#1e2d42" stroke={C.bd} strokeWidth="1"/>
        <circle cx="182" cy="112" r="38" fill="none" stroke="#334155" strokeWidth="8"/>
        <circle cx="182" cy="112" r="23" fill="none" stroke="#3b82f6" strokeWidth="5" opacity=".4"/>
        <circle cx="182" cy="112" r="8" fill={C.bd}/>
        <text x="182" y="172" textAnchor="middle" fill={C.t2} fontSize="13" fontFamily={ff}>HDD – mechanisch</text>
        <rect x="285" y="50" width="155" height="140" rx="8" fill="#1e2d42" stroke={C.cy} strokeWidth="1.5"/>
        {[0,1,2,3].map(r=>[0,1,2,3].map(c2=>(<rect key={`${r}-${c2}`} x={302+c2*30} y={68+r*22} width="24" height="17" rx="2" fill="#0f2744" stroke="#2563eb" strokeWidth="0.5"/>)))}
        <text x="362" y="172" textAnchor="middle" fill={C.cy} fontSize="13" fontFamily={ff}>SSD – Flash</text>
        <rect x="465" y="50" width="155" height="140" rx="8" fill="#2a1e42" stroke={C.am} strokeWidth="1.5"/>
        <rect x="487" y="82" width="111" height="46" rx="3" fill="#1e2d42" stroke={C.am} strokeWidth="1"/>
        {[0,1,2,3,4].map(i=>(<rect key={i} x={493+i*21} y={88} width="15" height="34" rx="1" fill="#0f2744" stroke={C.am} strokeWidth="0.5"/>))}
        {[...Array(9)].map((_,i)=>(<rect key={i} x={491+i*12} y={128} width="7" height="9" fill={C.am} opacity=".65"/>))}
