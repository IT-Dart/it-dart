...
const G=[
  ...
  {n:4,nm:"Datenspeicherung",th:"HDDs speichern auf magnetischen Scheiben – günstig, aber langsam. SSDs nutzen Flash-Speicher – schneller, leiser, robuster. RAM ist flüchtig: bei Stromausfall weg. Genau deshalb braucht ein Computer beides: RAM, weil die CPU nur so schnell auf Daten zugreifen kann, und einen dauerhaften Speicher wie SSD oder HDD, damit nach dem Ausschalten nichts verloren geht.",pc:"Der Techniker wählt SSD für das Betriebssystem und erklärt: Alles auf der SSD bleibt – aber ungespeichertes im RAM ist bei Stromausfall weg.",q1:"Warum bootet ein PC mit SSD schneller?",q2:"Was passiert mit RAM-Inhalt beim Neustart?"},
