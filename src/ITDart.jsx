...
export const Logo=({sz=44})=>(
  <svg width={sz} height={sz} viewBox="0 0 44 44" fill="none">
    <circle cx="22" cy="22" r="21" stroke="#2563eb" strokeWidth="2" fill="#1a2535"/>
    <circle cx="22" cy="22" r="14" stroke="#3b82f6" strokeWidth="1.6" fill="none"/>
    <circle cx="22" cy="22" r="7" stroke="#38bdf8" strokeWidth="1.6" fill="none"/>
