...
`id, email, is_admin, is_junior_admin, is_trainer, trainee_limit, is_premium, premium_until, rechentrainer_enabled, rechentrainer_until, ai_enabled, interview_enabled, confirmed_at, created_at, needs_password_setup, birthdate, parent_email, parent_consent_confirmed, parent_consent_token, agb_consent_given, display_ref, username, username_changed_at, username_welcome_seen`
